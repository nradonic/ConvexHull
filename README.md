Abstract exercise to generate random 2D points, and then to calculate and draw the convex hull around the points, and the inner convex hull. The inner hull is 
